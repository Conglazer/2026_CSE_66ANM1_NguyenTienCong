# 2026_CSE_66ANM1_NguyenTienCong
🎓 CCC WEB FRONTEND
...
Nắm vững HTML5 Semantic, CSS3 Modern Layout, và Responsive Design
Thành thạo JavaScript ES6+, DOM Manipulation, và Async Programming
Xây dựng Single Page Application với React/Vue
Kết nối và thao tác dữ liệu qua RESTful API
Phát triển dự án E-Commerce hoàn chỉnh sẵn sàng đưa vào portfolio
📚 Cấu trúc tài liệu
...
Getting Started - Bootstrap là gì? Cài đặt
Grid System - Hệ thống lưới 12 cột, Responsive
Components - Buttons, Cards, Navbar, Forms, Modals
Utilities - Spacing, Colors, Typography utilities
Customization - Customize với SASS variables
Lộ trình TailwindCSS (5 bài):

Getting Started - TailwindCSS là gì? Cài đặt
Utilities - Spacing, Colors, Typography, Flexbox, Grid
Components - Xây dựng Components từ utilities
Customization - Customize với config file
Advanced - @apply, Plugins, Performance optimization
Note

Lựa chọn Framework:

Bootstrap: Nếu bạn thích components có sẵn, thiết kế nhanh → Xem Bootstrap
TailwindCSS: Nếu bạn thích utility classes, thiết kế linh hoạt hơn → Xem TailwindCSS
...
Getting Started - Giới thiệu Angular & Setup
Components & Templates - Components, Data Binding, Directives
TypeScript in Angular - Types, Interfaces, Classes, Generics
Services & Dependency Injection - Services, DI System
Routing - Angular Router
Forms - Template-driven & Reactive Forms
HTTP Client - API Integration
RxJS - Reactive Programming
Advanced Topics - Change Detection, Lazy Loading, Testing
Note

Lựa chọn Framework:

React: Nếu bạn thích JSX, ecosystem lớn, React Native → Xem React
Vue.js: Nếu bạn thích template syntax dễ học, progressive framework → Xem Vue.js
Angular: Nếu bạn thích TypeScript, full-featured framework → Xem Angular
...
Đọc lý thuyết chậm rãi — Không bỏ qua bất kỳ phần nào
Gõ lại code, không copy/paste — Cách duy nhất để nhớ lâu
Chạy code ngay sau mỗi phần — Xem kết quả, debug, thử nghiệm
Làm bài tập thực hành — Củng cố kiến thức
Làm mini test — Tự đánh giá độ hiểu
Tích hợp vào BTL — Áp dụng ngay vào dự án thực tế
Hỏi khi chưa hiểu — Đừng để khoảng trống kiến thức
...
📝 License
Tài liệu này được phát triển cho mục đích giáo dục tại Đại học [Tên trường]. Mọi quyền được bảo lưu.
